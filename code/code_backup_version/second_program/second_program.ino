...
void joggen() {
    ...
    if (status_knop_tool_cw == HIGH) {
        servo_tool.writeMicroseconds(700);
        //servo_tool_pos++;
    }
...
void print() {
    ...
    if (servo_tool_pos != servo_tool_pos || last_stopvar != stop_moving) {
        Serial.print(" servo_tool_pos  = ");
        Serial.print(servo_tool_pos);
        Serial.println(" ");
    }
    last_var4 = servo_tool_pos;
...
void run_program() {
    ...
    case 1: // first position to go
        use_movespeed = 0;
        move_to_stepper1 = 1437;
        move_to_stepper2 = 10650;
        move_to_stepper3 = -10800;
        move_to_stepper4 = -48;
        move_to_stepper5 = -2424;
        move_to_stepper6 = 2030;
    ...
    case 10:
        servo_tool.writeMicroseconds(700);
        program_order = 20;
        if (millis() >= time_now + period1000_case10home) {
            time_now += period1000_case10home;;
            servo_tool.writeMicroseconds(1500);
            program_order = 20;
        }
        break;
    case 20: // second position to go
        ...
        move_to_stepper2 = 5996;
        move_to_stepper3 = -11587;
        move_to_stepper4 = -48;
        move_to_stepper5 = -738;
        move_to_stepper6 = 738;
    ...
    case 25: // third position to go
        use_movespeed = 0;
        move_to_stepper1 = 31868;
        move_to_stepper2 = 6553;
        move_to_stepper3 = -11104;
        move_to_stepper4 = -48;
        move_to_stepper5 = -1718;
        move_to_stepper6 = 352;
        Speed_max_stepper1 = 1000;
        Speed_max_stepper2 = 3000;
        Speed_max_stepper3 = 3000;
        Speed_max_stepper4 = 1000;
    ...
    case 30: // fourth position to go
        use_movespeed = 0;
        move_to_stepper1 = 32055;
        move_to_stepper2 = 8734;
        move_to_stepper3 = -696;
        move_to_stepper4 = -48;
        move_to_stepper5 = -3505;
        move_to_stepper6 = 1349;
