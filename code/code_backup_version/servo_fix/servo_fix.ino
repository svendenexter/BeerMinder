...
int home_all_axis() {
    ...
    case 22: //axis 3 ga even iets terug
        use_movespeed = 1;
        use_moveto_withspeed = 1;
        move_to_stepper3 = -4000; // iets terugdraaien na het nullen om opnieuw te homen
        Speed_stepper3 = -1500;
        stop_stepper3 = 0;
        homed_axis3 = 0;
...
void run_program() {
    ...
    case 30: // fourth position to go
        ...
        move_to_stepper2 = 10481;
        move_to_stepper3 = -12236;
        move_to_stepper4 = -81;
        move_to_stepper5 = 223;
        move_to_stepper6 = 4502;
    ...
    case 1000: // go to home position
        use_movespeed = 0;
        use_moveto_withspeed = 0;
        move_to_stepper1 = 1000;
        move_to_stepper2 = 1000;
        move_to_stepper3 = 1000;
        move_to_stepper4 = 1000;
        move_to_stepper5 = 1000;
        move_to_stepper6 = 1000;
        Speed_max_stepper1 = 5000;
        Speed_max_stepper2 = 5000;
        Speed_max_stepper3 = 5000;
        Speed_max_stepper4 = 5000;
        Speed_max_stepper5 = 5000;
        Speed_max_stepper6 = 5000;
        stop_stepper1 = 0;
        stop_stepper2 = 0;
        stop_stepper3 = 0;
        stop_stepper4 = 0;
