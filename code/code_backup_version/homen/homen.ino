...
int home_all_axis() {
    ...
    case 2: //axis 5
        if (status_switch_axis_5_cw == HIGH) {
            homed_axis5 = 1; //geen set point deze komt in axis 5
...
void print() {
    ...
    if (last_var2 != use_movespeed || last_stopvar != stop_moving) {
        Serial.print(" use_movespeed  = ");
        Serial.print(use_movespeed);
        Serial.println(" ");
    }
    last_var2 = use_movespeed;

    static int last_var3 = 999;
    if (last_var3 != move_stepper4 || last_stopvar != stop_moving) {
        Serial.print(" move_stepper4  = ");
        Serial.print(move_stepper4);
        Serial.println(" ");
    }
    last_var3 = move_stepper4;

    static int last_var4 = 999;
    if (last_var4 != Speed_stepper4 || last_stopvar != stop_moving) {
        Serial.print(" Speed_stepper4  = ");
        Serial.print(Speed_stepper4);
        Serial.println(" ");
    }
    last_var4 = Speed_stepper4;

    static int last_var5 = 999;
    if (last_var5 != stop_stepper4 || last_stopvar != stop_moving) {
        Serial.print(" stop_stepper4  = ");
        Serial.print(stop_stepper4);
        Serial.println(" ");
    }
    last_var5 = stop_stepper4;
