 ...
 */
 //page 0 startpage
NexButton b0 = NexButton(0, 2, "b0");  // next
// page 1
NexButton b0 = NexButton(1, 1, "b0");  // settings
NexButton b1 = NexButton(1, 5, "b1");  // programs
NexButton b2 = NexButton(1, 4, "b2");  // back
NexButton b3 = NexButton(1, 6, "b3");  // teach

// page 2 settings
NexButton b0 = NexButton(2, 1, "b0");  // home
NexButton b1 = NexButton(2, 2, "b1");  // jog
NexButton b2 = NexButton(2, 3, "b2");  // speed
NexButton b3 = NexButton(2, 4, "b3");  // back

// page 3 programs
NexButton b0 = NexButton(3, 1, "b0");  // program 1 
NexButton b1 = NexButton(3, 2, "b1");  // program 2
NexButton b2 = NexButton(3, 4, "b2");  // dance
NexButton b3 = NexButton(3, 3, "b3");  // back

// page 4 teach
NexButton b0 = NexButton(4, 1, "b0");  // pos 1 
NexButton b1 = NexButton(4, 2, "b1");  // pos 2
NexButton b2 = NexButton(4, 3, "b2");  // pos 3
NexButton b3 = NexButton(4, 4, "b3");  // pos 4 
NexButton b4 = NexButton(4, 5, "b3");  // pos 5
NexButton b5 = NexButton(4, 6, "b3");  // pos 6
NexButton b6 = NexButton(4, 7, "b3");  // back
NexButton b7 = NexButton(4, 8, "b3");  // save
NexButton b8 = NexButton(4, 9, "b3");  // clear
